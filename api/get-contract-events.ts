...
// DESCRIZIONE: Versione definitiva che include l'ABI direttamente nel file
// per eliminare l'errore ERR_MODULE_NOT_FOUND e garantire il funzionamento.

import type { VercelRequest, VercelResponse } from '@vercel/node';
import { createThirdwebClient, getContract, getContractEvents } from 'thirdweb';
import { polygon } from 'thirdweb/chains';

// --- MODIFICA CHIAVE 1: L'ABI è ora definito direttamente qui ---
...
export default async function handler(
  ...
  try {
    ...
    // L'ABI ora viene letto dalla costante definita in questo stesso file
